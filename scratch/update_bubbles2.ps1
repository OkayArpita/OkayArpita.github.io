$files = @(
    "betic/medha.astro",
    "betic/medic.astro",
    "e-yantra/2024-25.astro",
    "e-yantra/2025-26.astro"
)

$urlMap = @{
    "betic/medha.astro" = "https://www.betic.org/"
    "betic/medic.astro" = "https://www.betic.org/"
    "e-yantra/2024-25.astro" = "https://www.e-yantra.org/"
    "e-yantra/2025-26.astro" = "https://www.e-yantra.org/"
}
